  ...
  return (
    <div className='w-[70vw] mx-auto'>
        ...
        <div className='flex gap-2 my-2'>
            <button className='w-1/4 text-white0 border-1 border-black bg-black p-2 rounded hover:bg-white hover:text-black duration-200' onClick={() => console.log('volver')}>Cancelar</button>
            <button className='w-1/4 text-white0 border-1 border-black bg-black p-2 rounded hover:bg-white hover:text-black duration-200'  onClick={() => console.log('fin reserva')}>Confirmar reserva</button>
        </div>
    </div>
  )
}
