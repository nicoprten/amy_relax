                ...
                <div className='w-[60vw] mx-auto py-10 flex flex-wrap justify-center gap-2'>
                    {massages.map((m, i) => 
                        <div className='relative bg-white0 w-[300px] h-max rounded-xl' key={i}>
                            ...
                            <button className='absolute border-2 border-l-0 border-blue top-4 left-0 bg-blue text-white0 py-1 px-4  hover:bg-white0 hover:text-blue duration-200' onClick={() => handleBook(m.type)}>BOOK</button>
                        </div>
                    )}
                </div>
            :
