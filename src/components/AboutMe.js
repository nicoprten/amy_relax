  ...
  return (
    <div className='w-[60vw] mx-auto pt-28 pb-[4em] flex flex-col justify-between lg:flex-row' id='sobre-mi'>
        <div className='flex flex-col w-full rounded lg:w-3/4 lg:pr-10 xl:pr-20 w-full'>
          ...
          <button className='flex gap-4 items-center mx-auto sm:mx-0 text-center sm:text-left sm:w-max mt-4 py-2 px-4 bg-black text-white0 border-2 border-black hover:text-black hover:shadow-xl hover:bg-white0 duration-200'>
            Reserve your turn
          </button>
        </div>
